...
execute if score GAME_CHOSEN data matches 1 run function hall:vote/results/the_mountain
...
execute if score GAME_CHOSEN data matches 9 run function hall:vote/results/lava_dancers
